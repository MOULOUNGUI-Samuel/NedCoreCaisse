        ...
        <div class="page-content">
            <div class="row">
                @foreach ($users as $user)
                                ...
                                <div class="card-body border-dashed-bottom border-theme-color">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="{{ $user->photo ? asset('storage/' . $user->photo) : asset('assets/images/user.jpg') }}"
                                                alt="" class="rounded-circle thumb-xxl mx-auto d-inline-block">
                                        </div>
                    ...
                    @include('components.super_admin._associer_entreprise', [
                        'user' => $user,
                        'societesParUtilisateur' => $societesParUtilisateur,
                    ])
                @endforeach
            </div> <!--end col-->
        </div><!--end row-->
